                        ...
                        <tbody>
                            <?php foreach ($model as $estado) { ?>
                              <tr>
                                  ...
                                  <?php if (in_array('update', $permiso)): ?>
                                    <td>
                                        <?php echo CHtml::link('<i class=" fa fa-pencil"></i> ', CController::createUrl("update", array("id" => $estado->id)), array("class" => "btn btn-block btn-success")); ?>
                                    </td>
                                  <?php endif; ?>
                                  <?php if (in_array('borrar', $permiso)): ?>
                                    <td>
                                        <?php
                                        echo CHtml::link('<i class="fa fa-fw  fa-trash-o"></i> ', CController::createUrl("borrar", array("id" => $estado->id)), array("class" => "btn btn-block btn-danger", 'confirm' => '¿Estás seguro de borrar este elemento?'));
                                        ?>
                                    </td>
                                  <?php endif; ?>
                              </tr>
