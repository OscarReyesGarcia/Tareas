            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        ...
                        <a href="<?php echo CController::createUrl('create') ?>" title="Nuevo estado" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> </a>
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <table id="sample_1" class="table table-hover" id="tabla-usuarios">
                        ...
                        <tbody>
                            <?php foreach ($model as $tarea) { ?>
                              <tr>
                                  <td>
                                      <?php echo $tarea->id_usuario; ?>
                                  </td>
                                  <td>
                                      <?php echo $estado[$tarea->id_estado]; ?>
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                      <?php echo $tarea->fecha_registro; ?>
                                  </td>
                                  <?php if (in_array('update', $permiso)): ?>
                                    <td>
                                        <?php echo CHtml::link('<i class=" fa fa-pencil"></i> ', CController::createUrl("update", array("id" => $tarea->id)), array("class" => "btn btn-block btn-success")); ?>
                                    </td>
                                  <?php endif; ?>
                                  <?php if (in_array('borrar', $permiso)): ?>
                                    <td>
                                        <?php
                                        echo CHtml::link('<i class="fa fa-fw  fa-trash-o"></i> ', CController::createUrl("borrar", array("id" => $tarea->id)), array("class" => "btn btn-block btn-danger", 'confirm' => '¿Estás seguro de borrar este elemento?'));
                                        ?>
                                    </td>
                                  <?php endif; ?>
                              </tr>
