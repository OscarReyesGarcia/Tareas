...
<html>
    <head>
        ...
        <!--Custom css -->
        <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/customcss/admin.css">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Full</b> Nutrition</span>
                </a>
...
<?php if (!(Yii::app()->user->isGuest)) { ?>
                                  <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                      <img src="<?php echo Yii::app()->theme->baseUrl; ?>/dist/img/avatar04.png" class="user-image" alt="User Image"> 
                                      <span class="hidden-xs"><?php echo Yii::app()->user->name ?> </span><b class="caret"></b></a>
                                  <ul class="dropdown-menu">
  ...
  <?php echo Yii::app()->user->name ?>
                                      ...
                                      <li class="user-footer">
                                          ...
                                          <div class="pull-right">
                                              <a href="<?php echo CController::createUrl("site/logout") ?>" class="btn btn-default btn-flat"><i class="icon-off"></i> Cerrar Sesión</a>

                                          </div>
                                      </li>
                                  </ul>
                                <?php } else { ?>
                                  <a class="bg-white" href="<?php echo CController::createUrl("site/login") ?>"><i class="icon-key"></i> Iniciar sesión</a>
<?php } ?>
...
<?php } ?>
                    ...
                    <ul class="sidebar-menu tree" data-widget="tree">
                        <?php if (isset(Yii::app()->user->id_usuario)) { ?>
  <?php if (!empty(Yii::app()->user->id_rol) && (Yii::app()->user->id_rol) == 1 || (Yii::app()->user->id_rol) == 2) { ?>
                            <li>
                                <a href="<?php echo CController::createUrl('site/index') ?>"><i class="fa fa-dashboard fa-fw"></i> <span>Escritorio</span></a>
                            </li>
                            <?php
                            $grupo = "";
                            foreach ($permisos as $permiso) {
                              if ($grupo != $permiso->grupo) {
                                if ($grupo != "") {
                                  echo "</ul>";
                                  echo "</li>";
                                }
                                echo '<li class="treeview"><a href="#" class="treeviewdds"><i class="' . $permiso->icon . '"></i> <span> ' . $permiso->grupo . '</span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>';
                                echo '<ul id="' . $permiso->grupo . '" class="treeview-menu">';
                              }
                              echo "<li>" . CHtml::link($permiso->nombre, CController::createUrl($permiso->url)) . "<li/>";
                              $grupo = $permiso->grupo;
                            }
                            ?>
                          ...
                          <?php
                            ...
                            $url = 'usuarioPaciente/informacionGeneral/' . Yii::app()->user->id_usuario;
                            echo '<li><a href="' . CController::createUrl($url) . '"><i class="fontello-college"></i> Estudiantes<span class="fontello-right-open-outline"></span></a>';
                          }
                        } else {
                          ?>

                          <li>
                              <a href="<?php echo CController::createUrl("site/login") ?>"><i class="fa fa-key"></i> Iniciar sesión</a>
                          </li>
  <?php
}
?>                           
...
<?php echo $content; ?>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="#">All Suplements</a>.</strong> All rights reserved.
            </footer>
